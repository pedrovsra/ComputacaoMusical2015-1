 ...
 * McGill Univarsity
 */
package AudioLibs.Classifier.Fast.GeneralTools;
...
public class FFT {
     ...
     * transformed. This may be null if the signal is entirely real.
     * @param	inverse_transform	A value of false implies that a forward
     * transform is to be applied, and a value of true means that an inverse
     * transform is tob be applied.
     * @param	use_hanning_window	A value of true means that a Hanning window
     * will be applied to the real_input. A value of valse will result in the
     * application of a Hanning window.
     * @throws	Exception	Throws an exception if the real and imaginary inputs
     * are of different sizes or if less than three input samples are provided.
     */
     ...
     * of the spectrum is redundant for the purpose of the magnitude spectrum.
     * This means that the bins only go up to half of the sampling rate.
     *
     ...
     *
     * <p>Only the left side of the spectrum is returned, as the folded portion
     * of the spectrum is redundant for the purpose of the phase angles. This
     * means that the bins only go up to half of the sampling rate.
     *
     ...
     *
     * @param	sampling_rate	The sampling rate that was used to perform the FFT.
