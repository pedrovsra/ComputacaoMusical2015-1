 ...
 *
 */
package AudioLibs.Classifier.Fast.featureExtraction.Aggregators;

import AudioLibs.Classifier.Fast.dataTypes.AggregatorDefinition;
...
public abstract class Aggregator {
     ...
     *
     * @param featureIndecis Indecis of these features in the array passed in
     * aggregate
     * @throws Exception if either parameter is null, of dicffering lengths, or
     ...
     *
     * @param values complete array of the extracted features. Indecis are
     * window, feature, and then feature value.
     */
     ...
     *
     * @param output output stream to be used.
     * @throws Exception
     */
