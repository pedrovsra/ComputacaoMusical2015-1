...
public class BeatHistogram extends FeatureExtractor {
     ...
     * getDependencyOffsets methods respectively. The first index indicates the
     ...
     * @throws Exception thrown if the new value is less than 2
     */
     ...
     *
     * @param index which of Beat Histograms's attributes should be edited.
     */
