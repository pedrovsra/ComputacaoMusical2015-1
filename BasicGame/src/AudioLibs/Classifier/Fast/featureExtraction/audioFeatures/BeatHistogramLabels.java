 ...
 * McGill Univarsity
 */
package AudioLibs.Classifier.Fast.featureExtraction.audioFeatures;
 ...
 * a beat histogram.
 *
 * <p>Although this is not a useful feature for the purposes of classifying, it
 * can be useful for calculating other features.
 *
 * <p><b>IMPORTANT:</P> The window size of 256 RMS windows used in the
 * BeatHistogram is hard-coded into this class. Any changes to the value in that
 * class must be made here as well.
 *
 * <p>Daniel McEnnis	05-08-05	added setBinNumber, getElement, setElement, and
 * clone
 *
 * @author Cory McKay
 */
public class BeatHistogramLabels
     ...
     * @param other_feature_values	The values of other features that are needed
     * to calculate this value. The order and offsets of these features must be
     * the same as those returned by this class's getDependencies and
     * getDependencyOffsets methods respectively. The first indice indicates the
     * feature/window and the second indicates the value.
     * @return	The extracted feature value(s).
     * @throws Exception	Throws an informative exception if the feature cannot
     * be calculated.
     */
    public double[] extractFeature(double[] samples,
        ...
        if (beat_histogram != null) {
            ...
            double[] labels =
                    DSPMethods.getAutoCorrelationLabels(effective_sampling_rate,
                    min_lag,
                    max_lag);
